...
async function run() {
  try {
    ...
    app.patch("/update-review/:id", async (req, res) => {
      ...
      const updateReview = {
        $set: {
          coverImage: updatedDataFromBody.coverImage,
          gameTitle: updatedDataFromBody.gameTitle,
          reviewDescription: updatedDataFromBody.reviewDescription,
          rating: updatedDataFromBody.rating,
          publishingYear: updatedDataFromBody.publishingYear,
          genre: updatedDataFromBody.genre,
          email: updatedDataFromBody.email,
          userName: updatedDataFromBody.userName,
        },
      };
